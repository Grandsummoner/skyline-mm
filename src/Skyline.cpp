...
struct SlimFader : app::SvgSlider {
    // Compile-time checks choose 60px tracks for Desktop platforms (matching the panel layout),
    // and preserve the 40px scale when compiling under the 4ms Metamodule SDK environment.
